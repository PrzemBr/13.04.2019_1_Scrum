...
public class FizzBuzzWhizzTest {
    ...
    public void shouldReturnForNull(){
        ...
        String returned = FizzBuzzWhizz.perform(null);
    ...
    public void shouldReturnForThree(){
        String returned = FizzBuzzWhizz.perform(6);
    ...
    public void shouldReturnForFive(){
        String returned = FizzBuzzWhizz.perform(10);
    ...
    public void shouldReturnForFourthExample(){
        String returned = FizzBuzzWhizz.perform(15);
    ...
    public void shouldReturnForPrimeNumber(){
        String returned1 = FizzBuzzWhizz.perform(7);
        String returned2 = FizzBuzzWhizz.perform(3);
        String returned3 = FizzBuzzWhizz.perform(5);
